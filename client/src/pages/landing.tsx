          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center">
                ...
                <span className="text-2xl font-bold text-foreground">Adi Cheats Auth</span>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground mb-12">
                Join thousands of developers who trust Adi Cheats Auth for their authentication needs
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="flex items-center mb-4 md:mb-0">
                ...
                <span className="text-lg font-semibold text-foreground">Adi Cheats Auth</span>
              </div>
              <div className="text-sm text-muted-foreground">
                © 2024 Adi Cheats Auth. All rights reserved.
              </div>
            </div>
          </div>
        </footer>
